    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: '5 Signs Your Business Is Ready for AI Automation',
      },
    ],
    locale: 'en_NZ',
    type: 'article',
        ...
        <div className="mx-auto max-w-3xl">
          <FadeIn>
            ...
            <div className="mt-6 flex items-center gap-3">
              <span className="rounded-full bg-[var(--ga-blue)]/10 px-3 py-1 text-xs font-semibold text-[var(--ga-blue)]">
                AI Strategy
              </span>
        ...
        <div className="mx-auto max-w-3xl">
          <FadeIn>
            <div className="prose prose-invert max-w-none text-white/60 [&_p]:text-[16px] [&_p]:leading-relaxed">
              <p>
                AI automation is transforming how businesses operate — but not every company is
                ready to make the leap. Timing matters, and implementing AI too early (or
                without the right foundations) can waste resources.
              </p>
              <p>
                So how do you know when your business is actually ready? Here are five signals
                that suggest it&apos;s time to explore AI-powered automation.
              </p>
        ...
        <div className="mx-auto max-w-3xl text-center">
          <FadeIn>
            ...
            <p className="mx-auto mt-4 max-w-xl text-white/50">
              Book a free strategy call and we&apos;ll identify the biggest automation
